(function (window, document, $, undefined) {
    ...
    var axilInit = {
        ...
        methods: function (e) {
            ...
            axilInit.countdownInit('.coming-countdown', '2023/02/31');
            axilInit.campaignCountdown('.campaign-countdown', '2023/02/31');
            axilInit.countdownInit('.poster-countdown', '2023/02/31');
            axilInit.countdownInit('.sale-countdown', '2023/02/31');
